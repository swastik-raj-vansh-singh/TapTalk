...
export default function LandingPage() {
  const features = [{
    ...
    background: <div className="absolute inset-0 bg-gradient-to-br from-pink-500/30 to-rose-500/30 opacity-80" />,
    className: ""
  }, {
    Icon: Users,
    name: "Connect",
    ...
    href: "#connect",
    cta: "Find Your Tribe",
    background: <div className="absolute inset-0 bg-gradient-to-br from-blue-500/30 to-indigo-500/30 opacity-80" />,
    className: ""
  }, {
    Icon: Zap,
    name: "Engage",
    ...
    href: "#engage",
    cta: "Start Engaging",
    background: <div className="absolute inset-0 bg-gradient-to-br from-yellow-500/30 to-orange-500/30 opacity-80" />,
    className: ""
  }, {
    Icon: Globe,
    name: "Discover",
    ...
    href: "#discover",
    cta: "Explore Now",
    background: <div className="absolute inset-0 bg-gradient-to-br from-green-500/30 to-emerald-500/30 opacity-80" />,
    className: ""
  }];
  return <div className="min-h-screen relative overflow-x-hidden">
      ...
      <nav className="glass-effect sticky top-0 z-50 border-b border-white/10">
        <div className="max-w-7xl sm:px-6 lg:px-8 mx-[10px] my-0 px-0">
      ...
      <section className="relative h-screen w-screen flex flex-col justify-center items-center">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          delay: 0.4
            ...
            <div className="relative text-gray-900 font-extrabold" style={{
      ...
      <section id="features" className="py-20 px-4 bg-gradient-to-br from-gray-50/30 to-white/30">
        <div className="max-w-7xl mx-auto">
          ...
          delay: 0.2
            ...
            <BentoGrid>
              {features.map((feature, index) => <motion.div key={feature.name} initial={{
              opacity: 0,
              y: 30
            }} whileInView={{
              opacity: 1,
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <div className="flex space-x-4">
                <a href="https://github.com/swastik-raj-vansh-singh" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700 transition-colors">
                  <Github className="h-6 w-6" />
                </a>
                <a href="https://www.linkedin.com/in/swastikrajvanshsingh/" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700 transition-colors">
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                  </svg>
                </a>
                <a href="mailto:swastikrajvanshsingh0@gmail.com" className="text-gray-500 hover:text-gray-700 transition-colors">
          ...
          <div className="border-t border-gray-300 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-gray-600 text-sm mt-4 md:mt-0">
              Made with ❤️ by <a href="https://github.com/swastik-raj-vansh-singh" target="_blank" rel="noopener noreferrer" className="text-purple-500 hover:text-purple-600 transition-colors">
